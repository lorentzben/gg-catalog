...
duo_protein_gene_list <- generate_kegg_gene_list(duo_average_df, protein_digestion_and_absorption, kegg_gene)
...
duo_gastric_gene_list <-
duo_gastric_more_info <- 

duo_pancreatic_acid_gene_list <-
duo_pancreatic_more_info <- 

duo_valine_gene_list <-
duo_valine_more_info <-

duo_tyrosine_gene_list <-
duo_tyrosine_more_info <-

duo_tryptophan_gene_list <-
duo_tryptophan_more_info <-

duo_alanine_gene_list <- 
duo_alanine_more_info <- 

duo_nitrogen_gene_list <-
duo_nitrogen_more_info <-
```

```{r jejunum analysis}

jejunum_protein_gene_list <- generate_kegg_gene_list(jejunun_average_df, protein_digestion_and_absorption, kegg_gene)
...
jejunum_gastric_gene_list <-
jejunum_gastric_more_info <- 

jejunum_pancreatic_acid_gene_list <-
jejunum_pancreatic_more_info <- 

jejunum_valine_gene_list <-
jejunum_valine_more_info <-

jejunum_tyrosine_gene_list <-
jejunum_tyrosine_more_info <-

jejunum_tryptophan_gene_list <-
jejunum_tryptophan_more_info <-

jejunum_alanine_gene_list <- 
jejunum_alanine_more_info <- 

jejunum_nitrogen_gene_list <-
jejunum_nitrogen_more_info <-
```
