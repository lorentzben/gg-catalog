...
for (item in selected_gene_tab){
    curr_kegg <- item$ListOfKOs
    curr_gene <- item$kegg_gene
...
selected_gene_df <- data.table(selected_gene_tab)

more_info <- merge(selected_df, selected_gene_df, by.x="#KEGG", by.y="ListOfKOs")
