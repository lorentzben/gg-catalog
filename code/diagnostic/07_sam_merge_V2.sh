...
#SBATCH --job-name=07_MERGE_SAMS_V2
#SBATCH --ntasks=1
...
# These are needed if 05 was not performed
# sort gal-gal
...
singularity run docker://lorentzb/samtools samtools merge -c merged_reads_V2.sam */*_sorted.sam 
